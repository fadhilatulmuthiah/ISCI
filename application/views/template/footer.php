...
<!-- Default-JavaScript-File -->
	<script type="text/javascript" src="<?= base_url('assets/front_dashboard') ?>/js/jquery-2.2.3.min.js"></script>
	<script type="text/javascript" src="<?= base_url('assets/front_dashboard') ?>/js/bootstrap.js"></script>
<!-- //Default-JavaScript-File -->
<!--menu script-->
<script type="text/javascript" src="<?= base_url('assets/front_dashboard') ?>/js/modernizr-2.6.2.min.js"></script>
		<script src="<?= base_url('assets/front_dashboard') ?>/js/jquery.fatNav.js"></script>
		<script>
		(function() {
...
<!--Start-slider-script-->
	<script defer src="<?= base_url('assets/front_dashboard') ?>/js/jquery.flexslider.js"></script>
